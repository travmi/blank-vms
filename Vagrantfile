...
echo -e "172.16.40.5\tagent1\tagent1.local.lan\n172.16.40.6\tagent2\tagent2.local.lan\n172.16.40.7\tagent3\tagent3.local.lan\n" >> /etc/hosts
EOF
...
yum update -y
yum install vim git rsync wget -y
setenforce 0
...
Vagrant.configure(VAGRANTFILE_API_VERSION) do |config|
 ...
 config.vm.define "agent1" do |agent1|
    agent1.vm.box = "chef/centos-6.6"
    agent1.vm.hostname = "agent1.local.lan"
    agent1.vm.network :private_network, ip: "172.16.40.5"
 ...
 config.vm.define "agent2" do |agent2|
    agent2.vm.box = "chef/centos-6.6"
    agent2.vm.hostname = "agent2.local.lan"
    agent2.vm.network :private_network, ip: "172.16.40.6"
 ...
 config.vm.define "agent3" do |agent3|
    agent3.vm.box = "chef/centos-6.6"
    agent3.vm.hostname = "agent3.local.lan"
    agent3.vm.network :private_network, ip: "172.16.40.7"
